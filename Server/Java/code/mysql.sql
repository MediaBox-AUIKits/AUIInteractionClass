...
CREATE TABLE `class_infos` (
  ...
  `status` bigint(20) DEFAULT NULL COMMENT '1-开始上课,2-结束上课,0-暂停或没有上课',
  `mode` bigint(20) DEFAULT NULL COMMENT '0-公开,1-大班,2-小班',
  `a_li_yun_id` varchar(256) DEFAULT NULL COMMENT '阿里云',
  `rong_cloud_id` varchar(256) DEFAULT NULL COMMENT '融云',
  `pk_id` varchar(256) DEFAULT NULL COMMENT '',
  ...
  `vod_id` varchar(256) DEFAULT NULL COMMENT '',
  ...
  `boards` mediumtext DEFAULT NULL COMMENT '白板信息, JSON字符串',
