...
export declare namespace AliVCInteraction {
  class AliVCIMGroupManager extends EventEmitter<ImGroupListener> {
     ...
     */
    listRecentGroupUser(
      groupIdOrReq: string | ImListRecentGroupUserReq
    ): Promise<ImListRecentGroupUserRsp>;
    /**
     * 查询群组成员，限管理员才能操作
     ...
     */
    listGroupUser(
      groupIdOrReq: string | ImListGroupUserReq
    ): Promise<ImListGroupUserRsp>;
    /**
     * 全体禁言，限管理员才能操作
     ...
     */
    listMuteUsers(
      groupIdOrReq: string | ImListMuteUsersReq
    ): Promise<ImListMuteUsersRsp>;
  }
  ...
  class AliVCIMMessageManager extends EventEmitter<ImMessageListener> {
     ...
     */
    listRecentMessage(
      groupIdOrReq: string | ImListRecentMessageReq
    ): Promise<ImListRecentMessageRsp>;
    /**
     ...
     */
    listHistoryMessage(
      req: ImListHistoryMessageReq
    ): Promise<ImListHistoryMessageRsp>;
    /**
     * 删除/撤回群消息
     */
